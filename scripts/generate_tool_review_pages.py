    ...
    <section class="section">
      <div class="container container--narrow">
        <figure class="content-figure">
            <img src="/assets/images/content/tool-comparison-matrix.svg" alt="AI tool comparison matrix showing feature ratings for {name} and alternatives" loading="lazy" width="800" height="400">
            <figcaption>Independent tool ratings from PE Collective.</figcaption>
        </figure>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container container--narrow">
        <div class="cta-section">
          <h2 class="cta-section__title">New tools ship every week. We test them so you don't have to.</h2>
          <p class="cta-section__text">
            <strong>AI News Digest</strong> covers industry moves &amp; tool updates. <strong>AI Pulse</strong> covers salary data &amp; career strategy. Both free.
          </p>
